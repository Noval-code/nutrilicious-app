...
export function AboutSection() {
    return (
        <section id="tentang" className="w-full relative py-20 md:py-28 font-sans bg-white overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-72 h-72 bg-[#114C2A]/5 rounded-full -translate-x-1/2 -translate-y-1/2" />
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-center">
                        ...
                        <div className="space-y-6">
                            <div className="inline-flex items-center gap-2 bg-[#114C2A]/10 text-[#114C2A] px-4 py-2 rounded-full text-sm font-bold">
                            ...
                            <h3 className="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight leading-tight">
                                Dari Dapur Kecil Menjadi <span className="text-[#114C2A]">Catering Sehat</span> Pilihan Kota Tegal
                            </h3>
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-4">
                                <div className="bg-slate-50 rounded-2xl p-4 border border-gray-100 hover:border-[#114C2A]/20 transition-colors group">
                                    <div className="w-10 h-10 rounded-xl bg-[#114C2A]/10 text-[#114C2A] flex items-center justify-center mb-3 group-hover:bg-[#114C2A] group-hover:text-white transition-all">
